...
{  
    ...
    void Update() {
        ...
        GameObject AnswerInput = GameObject.Find("Canvas/textbookPage/AnswerInput");
        GameObject SkipButton = GameObject.Find("Canvas/textbookPage/SkipButton");
        GameObject ConfirmButton = GameObject.Find("Canvas/textbookPage/ConfirmButton");
        ...
        GameObject AnswerInputText = GameObject.Find("Canvas/textbookPage/AnswerInput/TextArea/Text");
